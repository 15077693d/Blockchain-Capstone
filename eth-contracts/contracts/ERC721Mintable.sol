...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public  {
        ...
        require(to!=owner," the given address to not be the owner of the tokenId");

        // ok TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(isApprovedForAll(owner, msg.sender) == true || owner == msg.sender, "require the msg sender to be the owner of the contract or isApprovedForAll() to be true");
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        // ok TODO return token approval if it exists
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    // ok TODO: Create private vars for token _name, _symbol, and _baseTokenURI (string)
    string private _name;
    string private _symbol;
    string private _baseTokenURI; 
    // ok TODO: create private mapping of tokenId's to token uri's called '_tokenURIs'
...
contract RealEstate is ERC721Metadata("OscarRealEstate","ORE","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
